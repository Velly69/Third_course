...
public class App extends JFrame {
    ...
    private static final JButton btnAddGenre = new JButton("Add Genre");
    private static final JButton btnAddMovie = new JButton("Add Movie");
    ...
    private static final Box moviePanel = Box.createVerticalBox();
    private static final Box genrePanel = Box.createVerticalBox();

    private static final JComboBox comboGenre = new JComboBox();
    private static final JComboBox comboMovie = new JComboBox();

    private static final JTextField textGenreName = new JTextField(30);
    private static final JTextField textMovieName = new JTextField(30);
    private static final JTextField textMovieGenreName = new JTextField(30);
    private static final JTextField textMovieYear = new JTextField(30);
    ...
    private static void save() {
        if (editMode) {
            if (genreMode) {
                ...
                GenreDTO genre;
                genre = client.genreFindByName(textMovieGenreName.getText());
                if (genre == null) {
