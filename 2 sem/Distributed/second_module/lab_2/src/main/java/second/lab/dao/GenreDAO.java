...
public class GenreDAO {
    ...
    public static boolean update(GenreDTO country) {
        try (Connection connection = CustomConnection.getConnection()) {
    ...
    public static boolean insert(GenreDTO country) {
        try (Connection connection = CustomConnection.getConnection()) {
    ...
    public static boolean delete(GenreDTO country) {
        try (Connection connection = CustomConnection.getConnection()) {
